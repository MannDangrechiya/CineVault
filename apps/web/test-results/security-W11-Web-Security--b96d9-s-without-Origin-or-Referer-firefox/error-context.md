...
- Name: security.spec.ts >> W11 Web Security & CSRF Gateway Tests >> BFF Proxy rejects state-changing requests without Origin or Referer
- Location: tests\security.spec.ts:18:7
