...
async function runW13ProductionSmokeSuite() {
  ...
  try {
    ...
    await page.goto(`${baseUrl}/series`, { waitUntil: 'networkidle', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 10000 });
    results.passed.push('series_catalog_loaded');

    // 4. Search Page
    console.log('--- 4. Search & Discovery ---');
    await page.goto(`${baseUrl}/search?q=Inception`, { waitUntil: 'networkidle', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 10000 });
    ...
    await page.goto(`${baseUrl}/import`, { waitUntil: 'networkidle', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 10000 });
    results.passed.push('import_wizard_loaded');

    // 14. Settings Page
    console.log('--- 14. Settings & Account Hub ---');
    await page.goto(`${baseUrl}/settings`, { waitUntil: 'networkidle', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 10000 });
