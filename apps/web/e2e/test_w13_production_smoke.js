...
async function runW13ProductionSmokeSuite() {
  ...
  try {
    ...
    await page.goto(`${baseUrl}/series`, { waitUntil: 'domcontentloaded', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 15000 });
    results.passed.push('series_catalog_loaded');

    // 4. Search Page
    console.log('--- 4. Search & Discovery ---');
    await page.goto(`${baseUrl}/search?q=Inception`, { waitUntil: 'domcontentloaded', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 15000 });
    ...
    await page.goto(`${baseUrl}/import`, { waitUntil: 'domcontentloaded', timeout: 20000 });
    await page.waitForSelector('main', { timeout: 15000 });
