...
export default function MovieDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="p-8">
        <LoadingState message="Loading cinematic details & neural embeddings..." />
      </div>
    );
  }
  ...
  return (
    <div className="relative -mt-4 sm:-mt-6 lg:-mt-8 -mx-4 sm:-mx-6 lg:-mx-8 min-h-screen bg-zinc-950 text-zinc-50 pb-20">
      ...
      <div className="absolute top-6 left-6 z-30">
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-950/70 backdrop-blur-xl border border-zinc-800 text-xs font-medium text-zinc-300 hover:text-white hover:bg-zinc-900 transition-all shadow-lg"
        >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-900 space-y-4">
            <div className="flex items-center gap-2 text-sm font-bold text-zinc-200">
              ...
              <span>Canonical Metadata & Edition Provenance</span>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-900 space-y-3">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Share your favorite movies with zero social feed noise. Recommendations land cleanly in friends&apos; OLED inbox.
            </p>
            <button
              onClick={() => setIsRecommendModalOpen(true)}
            ...
            {recommendSent ? (
              ...
              <form onSubmit={handleSendRecommendation} className="space-y-4 pt-4">
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    placeholder="Why they need to watch this cinematic masterpiece..."
                    value={personalNote}
