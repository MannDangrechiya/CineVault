...
# Implements /health/liveness and /health/readiness probes
...
async def readiness_probe():
    """Readiness probe: verifies operational dependencies (PgBouncer, Valkey)."""
    db_health = db_manager.check_health()
    valkey_health = valkey_manager.check_health()
    
    is_ready = db_health["status"] == "HEALTHY" and valkey_health["status"] == "HEALTHY"
